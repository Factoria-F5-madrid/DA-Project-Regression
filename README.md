...
Para este proyecto vamos a utilizar un dataset que podamos abordar como un problema de regresión, te dejaremos como recurso la siguiente competición de Kaggle: [Regression of Used Car Prices](https://www.kaggle.com/competitions/playground-series-s4e9) , solo como sugerencia en caso de no encontrar un dataset adecuado, más instamos a la autenticidad de vosotrxs!
